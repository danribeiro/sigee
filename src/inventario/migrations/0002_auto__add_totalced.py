...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TotalCED'
        db.create_table('inventario_totalced', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ced', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['inventario.CED'], unique=True)),
            ('fossilced_co2', self.gf('django.db.models.fields.FloatField')()),
            ('fossilced_ch4', self.gf('django.db.models.fields.FloatField')()),
            ('fossilced_n2o', self.gf('django.db.models.fields.FloatField')()),
            ('bioced_co2', self.gf('django.db.models.fields.FloatField')()),
            ('bioced_ch4', self.gf('django.db.models.fields.FloatField')()),
            ('bioced_n2o', self.gf('django.db.models.fields.FloatField')()),
            ('emissoes_equivalentes_ced', self.gf('django.db.models.fields.FloatField')()),
            ('emissoes_biomassa_ced', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('inventario', ['TotalCED'])


    def backwards(self, orm):
        
        # Deleting model 'TotalCED'
        db.delete_table('inventario_totalced')
    ...
    models = {
        ...
        'inventario.totalced': {
            ...
            'ced': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['inventario.CED']", 'unique': 'True'}),
